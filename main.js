...
import LissajousVisualization from './lissajous.js'; // Ensure import is present
...
const sketch = (p) => {
    ...
    // *** ADDED FULL LISSAJOUS EXPLANATION TEXT ***
    const explanations = {
    ...
    p.setup = () => { // ... (Setup identical - gets elements, instantiates viz, attaches listeners) ...
        ...
        updateParams(); visualizationChanged();
    ...
    function visualizationChanged() { // ... (Identical - uses .elt.innerHTML) ...
        ...
        // Use the full explanations object defined above
        const explanationHTML = explanations[currentVizKey] || "";
        if (explanationContainerDiv) {
             try {
                 explanationContainerDiv.elt.innerHTML = explanationHTML; // Use innerHTML
    ...
    // Specific controls are updated within their respective modules now
