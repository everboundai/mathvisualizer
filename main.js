...
import LissajousVisualization from './lissajous.js'; // Add back import
...
const sketch = (p) => {
    ...
    const vizDisplayNames = {
        ...
        lissajous: "Lissajous Curves", lsystem: "L-System Generator" // Add all back
    };
    const formulas = {
        ...
        lissajous: `x = A&sdot;sin(a&sdot;t + &delta;), y = B&sdot;sin(b&sdot;t)`, // Add back
        lsystem: `L-System Turtle Graphics`
    };
    const explanations = { // Ensure full text is present here for all
    ...
    p.setup = () => {
        ...
        // Instantiate ALL Visualization Modules
        visualizations = {};
        try {
             ...
             visualizations['lissajous'] = new LissajousVisualization(p, p.select('#lissajousControls')); // Add back instantiation
    ...
    p.draw = () => {
        ...
        if (activeViz?.draw) {
            ...
            const needsCentering = (currentVizKey === 'flower' || currentVizKey === 'lissajous' || currentVizKey === 'lsystem'); // Add lsystem
        ...
        } else if (currentVizKey) { // Only warn if key is not 'about'
    ...
    function visualizationChanged() {
        ...
        if (activeViz && typeof activeViz.showControls === 'function') {
            activeViz.showControls();
             if(typeof activeViz.activate === 'function') { activeViz.activate(); } // Call activate if needed
